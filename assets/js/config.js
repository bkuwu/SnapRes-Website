/* =========================================================================
   SnapRes — SITE CONFIG
   -------------------------------------------------------------------------
   ⚠️ EDIT ME: this is the ONLY file you need to touch to update links.
   Every download button, GitHub icon, YouTube link and email on the whole
   site reads from this object at load time. Change a value here and it
   updates everywhere automatically.

   When you have your own domain / direct-download link ready, just swap
   DOWNLOAD_URL below — nothing else needs to change.
   ========================================================================= */
window.SNAPRES_CONFIG = {
  ...
  DOWNLOAD_URL: "https://github.com/bkuwu/SnapRes/releases/download/v1.0.6/SnapRes.exe",
